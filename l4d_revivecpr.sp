...
//#define SOUND_REVIVE_1 "common/bugreporter_succeeded.wav"
//#define SOUND_REVIVE_END "buttons/bell1.wav"
#define SOUND_REVIVE_1 "buttons/bell1.wav"
#define SOUND_REVIVE_END "items/suitchargeok1.wav"

#define PARTICLE_LIGHT_1 "weapon_pipebomb_blinking_light" // red
#define PARTICLE_LIGHT_2 "railroad_light_blink2" // green
#define PARTICLE_LIGHT_3 "railroad_light_blink4" // red bright
...
public void OnMapStart()
{
	...
	PrecacheSound(SOUND_REVIVE_1, true);
	PrecacheSound(SOUND_REVIVE_END, true);
	...
	//PrecacheParticleEffect(PARTICLE_LIGHT_1);
	//PrecacheParticleEffect(PARTICLE_LIGHT_2);
	PrecacheParticleEffect(PARTICLE_LIGHT_3);
}
...
public Action evtPlayerSpawn(Event event, const char[] name, bool dontBroadcast)
{
	...
	if(GetClientTeam(client)==2)//&& !IsPlayerAlive(client))
	{
		...
		{
			KillParticle(GhostLight[client]);
		}
		GhostLight[client]=0;
	}
}
...
{
	Action result;
	EmitSoundToAll(SOUND_REVIVE_END, client, SNDCHAN_AUTO, SNDLEVEL_GUNFIRE, SND_NOFLAGS, SNDVOL_NORMAL, SNDPITCH_NORMAL, -1, NULL_VECTOR, NULL_VECTOR, true, 0.0);
...
void ShowBar(int client, int dead, float pos, int max, bool firstaidkit) 
{
	...
	if (pos == 0.0) {
		EmitSoundToAll(SOUND_REVIVE_1, client, SNDCHAN_AUTO, SNDLEVEL_GUNFIRE, SND_NOFLAGS, SNDVOL_NORMAL, SNDPITCH_NORMAL, -1, NULL_VECTOR, NULL_VECTOR, true, 0.0);
	}
