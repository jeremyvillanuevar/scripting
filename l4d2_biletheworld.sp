...
ConVar vomitjarFriendlyFireEnabled=null;
...
public void OnPluginStart()
{
	...
	vomitjarFriendlyFireEnabled = CreateConVar("l4d2_bile_the_world_vomitjarfriendlyfireenabled", "0", "Turn Vomit Jar FriendlyFire on and off ", 						FCVAR_NONE|FCVAR_REPLICATED);
...
{		
	...
	if (GetConVarBool(vomitjarFriendlyFireEnabled))// case Vomit Jar Explosion, since it already hits Infected we only need to check Survivors
	{
		for (int i = 1; i <= MaxClients; i++)
		{
