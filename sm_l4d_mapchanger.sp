...
public void OnPluginStart()
{
	...
	cvarAnnounce = CreateConVar("sm_l4d_fmc_announce", "1", "Enables next mission and how many rounds (tries) events chances left to advertise to players.", FCVAR_NOTIFY, true, 0.0, true, 1.0 );
