...
public OnPluginStart()
{
	...
	cvarRespawnOnlyNotInFlow = CreateConVar("l4d2_survivorrespawn_onlynotinflow", "1", "Allows Bots to respawn automatically ONLY when out on flow", FCVAR_PLUGIN, true, 0.0, true, 1.0);
