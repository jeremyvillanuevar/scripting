...
public void OnPluginStart()
{
    ...
    g_hCvar_PistolMagnum  = CreateConVar("l4d2_wskin_rng_pistol_magnum", "1", "Enable/Disable weapon skin RNG for Pistol Magnum.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_PumpShotgun   = CreateConVar("l4d2_wskin_rng_pumpshotgun", "1", "Enable/Disable weapon skin RNG for Pump Shotgun.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_ShotgunChrome = CreateConVar("l4d2_wskin_rng_shotgun_chrome", "1", "Enable/Disable weapon skin RNG for Chrome Shotgun.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_AutoShotgun   = CreateConVar("l4d2_wskin_rng_autoshotgun", "1", "Enable/Disable weapon skin RNG for Auto Shotgun.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_SmgUzi        = CreateConVar("l4d2_wskin_rng_smg", "1", "Enable/Disable weapon skin RNG for SMG Uzi.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_SmgSilenced   = CreateConVar("l4d2_wskin_rng_smg_silenced", "1", "Enable/Disable weapon skin RNG for Silenced SMG.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_RifleM16      = CreateConVar("l4d2_wskin_rng_rifle_m16", "1", "Enable/Disable weapon skin RNG for M16 Rifle.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_RifleAK47     = CreateConVar("l4d2_wskin_rng_rifle_ak47", "1", "Enable/Disable weapon skin RNG for AK47 Rifle.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_HuntingRifle  = CreateConVar("l4d2_wskin_rng_hunting_rifle", "1", "Enable/Disable weapon skin RNG for Hunting Rifle.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_CricketBat    = CreateConVar("l4d2_wskin_rng_cricket_bat", "1", "Enable/Disable weapon skin RNG for Cricket Bat melee.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_Crowbar       = CreateConVar("l4d2_wskin_rng_crowbar", "1", "Enable/Disable weapon skin RNG for Crowbar melee.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
...
{
    g_smWeaponIdToClassname = CreateTrie();
...
public void CreateStringMaps()
{
    g_smWeaponCount = CreateTrie();
...
public void OnEntityCreated(int entity, const char[] classname)
{
    ...
    if (StrContains(classname, "weapon") != 0)
        return;
...
public void UpdateWeaponSkin(int entity)
{
    ...
    else if (StrEqual(classname, "weapon_melee_spawn"))
    {
        ...
        if (!g_smModelCount.GetValue(sModelName, count))
            return;
    }
    ...
    if (StrContains(classname, "_spawn") != -1)
